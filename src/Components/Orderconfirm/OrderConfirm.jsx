...
const OrderConfirm = () => {
  return (
    <Box w={"95%"} m="auto">
      <Alert status="info" borderRadius="10px" mt={10}>
        <AlertIcon />
        <Text fontSize={"14px"} fontWeight="600">
          {" "}
          Cartify will never contact you to offer products, cash or free prizes,
      ...
      <Flex justify={"center"} mt={10}>
        <Box textAlign={"center"}>
          ...
          <Heading my={3} fontWeight={"600"}>
            Order Confirmed!
          </Heading>
          <Text color={"gray"}>
            We are pleased to confirm your order no.#NYK-127609671-7238228
          </Text>

          <Link to="/">
            <Text fontWeight={"bold"} color="blue" mt={5}>
              Continue Shopping <ChevronRightIcon w={6} h={6} />
            </Text>
          </Link>
        </Box>
      </Flex>
