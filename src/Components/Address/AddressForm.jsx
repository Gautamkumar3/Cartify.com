                  ...
                  <Field
                    ...
                    validate={(value) => {
                      ...
                      if (!value) {
                        ...
                        error =
                          "Pin code is too short it must contain 6 numbers.";
                      } else if (value.length > 6) {
                        error =
                          "Pin code length is too long it must contain 6 numbers only.";
                      }
                      return error;
                    }}
                  />
                  ...
                  <Field
                    ...
                    validate={(value) => {
                      ...
                      if (!value) {
                        ...
                        error =
                          "Phone number is too short it must contain 10 letters.";
                      } else if (value.length > 10) {
                        error =
                          "Phone number length is too long it must contain 10 letters only.";
                      }
                      return error;
                    }}
                  />
